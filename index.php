...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($result->num_rows == 1) {
            ...
            echo '<script>
                      ...
                      alert("Login failed.Invalid Email or password , Try Again");
                      </script>';
        }
    ...
    <header class="header">
        ...
        <form action="" method="POST" class="login-form" id="schedule">
            ...
            <label for="" class="close-btn fas fa-times" id="schedule"></label>
            <h3>login form</h3>

            <label>Email</label>
            <input type="Email" placeholder="Enter your email" id="Email" name="Email" class="box" required>
            <label>Password</label>
            <input type="Password" placeholder="Enter your password" id="Password" name="Password" class="box" required>
            <div class="remember">
                <input type="checkbox" name="" id="remember-me">
                <label for="remember-me">remember me</label>
            </div><br>
            <div class="Forgot-Password"><a href="Register.php">Forgot-password ? </a></div>
            <!-- <a href="PetCare_Register.php" class="btn">login</a> -->
